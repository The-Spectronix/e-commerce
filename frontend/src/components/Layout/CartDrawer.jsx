...
<div className='p-4 bg-white sticky bottom-0'>
  ...
  <>
  <button onClick={handleCheckout} className='w-full bg-black rounded-lg text-white py-3 font-semibold hover:bg-gray-800 transition'>Checkout</button>
<p className='text-sm text-gray-500 mt-2 text-center tracking-tighter'>Shipping, axes, and discount codes calculated at checkout.</p>
