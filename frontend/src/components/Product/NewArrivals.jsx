...
const NewArrivals = () => {
    ...
    return (
        <section className='py-16 px-4 lg:px-0'>
            <div className='max-w-7xl mx-auto text-center mb-10 relative'>
            ...
            <div
                ref={scrollRef}
                className={`max-w-7xl mx-auto overflow-x-scroll scrollbar-hide flex space-x-6 relative ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}
