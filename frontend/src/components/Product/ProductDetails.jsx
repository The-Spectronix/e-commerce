      ...
      <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
        <div className='flex flex-col md:flex-row'>
            ...
            <div className="md:w-1/2">
                <div className="mb-4">
                    <img src={mainImage} alt={selectedProduct.images?.[0]?.alt} className="w-full h-auto object-cover rounded-lg" />
                </div>
            </div>
            {/* Mobile Thumbnail */}
                    ...
                    <div className="flex gap-2 mt-2">
                        {selectedProduct.sizes.map((size) => (
                            <button 
                                ...
                                className={`px-4 py-2 border rounded cursor-pointer ${selectedSize === size ? 'text-white bg-black' : ''}`}
                            >
                                {size}
                            </button>
                        ))}
                ...
                <button onClick={handleAddToCart} disabled={isButtonDisabled} className={`bg-black text-white py-2 px-6 rounded w-full ${isButtonDisabled ? "cursor-not-allowed opacity-50" : "hover:bg-gray-900"}`}>{isButtonDisabled ? "Adding..." : "ADD TO CART"}</button>
